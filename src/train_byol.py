...
my_parser = argparse.ArgumentParser(description="Trains BYOL on a given dataset.")
my_parser.add_argument(
    "--config_path",
    type=str,
    required=True,
    help="Path to the config yaml for BYOL.",
)
...
if __name__ == "__main__":
    ...
    byol_trainer = BYOLTrainer(train_dataset, val_dataset, config, args.config_path)
